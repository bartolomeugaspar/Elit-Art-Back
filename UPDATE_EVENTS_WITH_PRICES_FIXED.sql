...
-- Se os usuários não existirem, crie-os (execute se necessário):
-- INSERT INTO users (email, password_hash, name, role, is_verified, created_at, updated_at) VALUES
-- ('admin@elit-Arte.com', 'hash_placeholder', 'Admin', 'admin', true, NOW(), NOW()),
-- ('faustino@elit-Arte.com', 'hash_placeholder', 'Faustino', 'Arteist', true, NOW(), NOW()),
-- ('josemara@elit-Arte.com', 'hash_placeholder', 'Josemara', 'Arteist', true, NOW(), NOW());

-- Limpar todos os eventos existentes
DELETE FROM events;

-- Adicionar eventos com preço e coordenadas bancárias
-- Substitua os UUIDs abaixo pelos IDs reais dos usuários obtidos da query acima
INSERT INTO events (
  title, 
  description, 
  full_description, 
