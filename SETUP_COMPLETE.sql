-- ============================================
-- PASSO 1: Criar usuários (se não existirem)
-- ============================================
INSERT INTO users (email, password, name, role, is_email_verified, is_active, created_at, updated_at) 
VALUES
('admin@elit-Arte.com', '$2b$10$abcdefghijklmnopqrstuvwxyz123456789', 'Admin', 'admin', true, true, NOW(), NOW()),
('faustino@elit-Arte.com', '$2b$10$abcdefghijklmnopqrstuvwxyz123456789', 'Faustino', 'user', true, true, NOW(), NOW()),
('josemara@elit-Arte.com', '$2b$10$abcdefghijklmnopqrstuvwxyz123456789', 'Josemara', 'user', true, true, NOW(), NOW())
ON CONFLICT (email) DO NOTHING;

-- ============================================
-- PASSO 2: Verificar usuários criados
-- ============================================
SELECT id, email, role FROM users WHERE email IN ('admin@elit-Arte.com', 'faustino@elit-Arte.com', 'josemara@elit-Arte.com');

-- ============================================
-- PASSO 3: Limpar eventos antigos
-- ============================================
DELETE FROM events;

-- ============================================
-- PASSO 4: Inserir novos eventos com preço
-- ============================================
INSERT INTO events (
  title, 
  description, 
...
-- ============================================
-- PASSO 5: Verificar eventos criados
-- ============================================
...
-- RESULTADO ESPERADO
-- ============================================
-- 5 eventos inseridos com sucesso:
