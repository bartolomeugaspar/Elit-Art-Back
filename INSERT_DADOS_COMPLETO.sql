...
VALUES
  ('A Importância da Arte Contemporânea', 'importancia-arte-contemporanea', 'A arte contemporânea desempenha um papel crucial na sociedade moderna, servindo como espelho das questões sociais e políticas do nosso tempo...', 'Descubra por que a arte contemporânea é essencial para entender o mundo atual.', 'https://elit-arte.vercel.app/icon.jpeg', 'article', 'Redação Elit''Art', 'published', '2025-01-15'),
  ('Contos de Autores Angolanos', 'contos-autores-angolanos', 'Uma seleção de contos curtos de autores angolanos que exploram temas de identidade, cultura e tradição...', 'Leia histórias inspiradoras de escritores angolanos.', 'https://elit-arte.vercel.app/icon.jpeg', 'story', 'Redação Elit''Art', 'published', '2025-01-20'),
  ('Poesia: Expressão da Alma', 'poesia-expressao-alma', 'A poesia é uma forma de arte que permite expressar sentimentos e emoções de maneira profunda e significativa...', 'Explore a beleza e profundidade da poesia.', 'https://elit-arte.vercel.app/icon.jpeg', 'poetry', 'Redação Elit''Art', 'published', '2025-02-01'),
  ('Revista Elit''Art - Edição Especial', 'revista-elit-art-especial', 'Conheça os destaques da nossa edição especial com entrevistas exclusivas e análises profundas...', 'A edição mais completa da revista Elit''Art.', 'https://elit-arte.vercel.app/icon.jpeg', 'magazine', 'Redação Elit''Art', 'published', '2025-02-10'),
  ('Drama e Teatro: Expressão Artística', 'drama-teatro-expressao', 'O teatro é uma forma de arte que combina atuação, cenografia e música para criar experiências inesquecíveis...', 'Descubra a magia do teatro e do drama.', 'https://elit-arte.vercel.app/icon.jpeg', 'drama', 'Redação Elit''Art', 'draft', NULL),
  ('Tendências de Arte Digital em 2025', 'tendencias-arte-digital-2025', 'A arte digital continua evoluindo com novas tecnologias e ferramentas que permitem aos artistas criar obras inovadoras...', 'Conheça as principais tendências de arte digital.', 'https://elit-arte.vercel.app/icon.jpeg', 'article', 'Redação Elit''Art', 'draft', NULL);

INSERT INTO artworks (title, description, artist_name, type, year, dimensions, medium, image_url, price, is_available, is_featured)
VALUES
  ('Reflexão Urbana', 'Pintura que retrata a vida urbana moderna com cores vibrantes', 'Faustino Mulumba', 'painting', 2023, '100x80cm', 'Acrílico sobre tela', 'https://elit-arte.vercel.app/icon.jpeg', 5000.00, TRUE, TRUE),
  ('Escultura Abstrata', 'Escultura em madeira que explora formas geométricas abstratas', 'Josemara Silva', 'sculpture', 2024, '150cm altura', 'Madeira de mogno', 'https://elit-arte.vercel.app/icon.jpeg', 8000.00, TRUE, TRUE),
  ('Paisagem Angolana', 'Fotografia que captura a beleza natural de Angola', 'Fotógrafo Anônimo', 'photography', 2024, '60x90cm', 'Impressão em papel fotográfico', 'https://elit-arte.vercel.app/icon.jpeg', 1500.00, TRUE, FALSE),
  ('Código Criativo', 'Arte digital que combina programação e criatividade visual', 'Artista Digital', 'digital', 2025, 'Formato digital', 'Técnica digital', 'https://elit-arte.vercel.app/icon.jpeg', 2000.00, TRUE, FALSE),
  ('Fusão de Técnicas', 'Obra mista que combina pintura, colagem e elementos tridimensionais', 'Criador Experimental', 'mixed_media', 2024, '120x120cm', 'Técnica mista', 'https://elit-arte.vercel.app/icon.jpeg', 3500.00, TRUE, FALSE);
...
VALUES
  ('Bem-vindo à Comunidade Elit''Art!', 'Este é o espaço para discussões sobre arte, eventos e colaborações. Sinta-se livre para compartilhar suas ideias!', 'general', 'Administrador', TRUE, FALSE),
  ('Técnicas de Pintura Acrílica', 'Compartilhem suas experiências e dicas sobre pintura acrílica. Qual é a sua técnica favorita?', 'art', 'Membro da Comunidade', FALSE, FALSE),
  ('Próximos Eventos da Elit''Art', 'Fique atualizado sobre os próximos eventos, exposições e workshops organizados pela Elit''Art.', 'events', 'Administrador', TRUE, FALSE),
  ('Oportunidades de Colaboração', 'Procurando parceiros para projetos artísticos? Este é o lugar certo para encontrar colaboradores!', 'collaboration', 'Membro da Comunidade', FALSE, FALSE),
  ('Feedback e Sugestões', 'Sua opinião é importante! Compartilhe sugestões para melhorar a plataforma Elit''Art.', 'feedback', 'Membro da Comunidade', FALSE, FALSE);
